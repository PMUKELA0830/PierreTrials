...
public interface PersonFavoriteRepo extends JpaRepository<PersonFavorite, String>{
	...
	List<PersonFavorite> findPersonContact(String keyword);
	...
	Optional<PersonFavorite> updateContact(String firstName, 
								   String middleName, 
								   String lastName,
								   String phoneNumber,
								   String phoneNum);
