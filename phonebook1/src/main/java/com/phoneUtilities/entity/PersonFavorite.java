...
//		}
		...
		public PersonFavorite(String firstName,  
				  	  String lastName, 
				  	  String phoneNumber) {
...
//		}
		...
		public String getPersonFavorite() {
			
			String contact ="";
			String personFavoriteContact = "";
			...
			personFavoriteContact = contact + getAddress() + "\n" 
					+ "Phone Number: " + formatPhone(getPhoneNumber()) + "\n"
					+ "-----------------------------------------";
			
			return personFavoriteContact;
